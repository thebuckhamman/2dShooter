...
public class Enemy {
	...
	public Enemy(int type, int rank) throws Exception{
		this.type = type;
		this.rank = rank;
		...
		{
			System.out.println("ERROR! Undefined Enemy Type:" + type);
			throw new Exception("Undefined enemy Type: " + type);
		}
